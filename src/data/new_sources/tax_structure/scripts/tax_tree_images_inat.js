...
const CONFIG = {
    ...
    OUTPUT_FILE: 'taxonomic_tree_images_inat.json',
    TARGET_CLASSES: ['Aves', 'Mammalia','Insecta','Amphibia','Reptilia','Arachnida','Actinopterygii','Gastropoda','Clitellata'],
